 ...
 */
var Unrar = function(options: any) {
 ...
 */
Unrar.prototype.list = function(done: any) {
  var self = this;

  self._exec(['vt', '-v'], function(err: any, stdout: any) {
    if (err) {
      return done(err);
    }
 ...
 */
Unrar.prototype.stream = function(entryname: any) {
 ...
 * @param  {Function} done Callback
 */
Unrar.prototype._exec = function(args: any, done: any) {
  var self = this;
